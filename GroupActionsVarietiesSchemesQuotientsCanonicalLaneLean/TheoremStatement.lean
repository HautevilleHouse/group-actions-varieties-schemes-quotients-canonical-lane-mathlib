import GroupActionsVarietiesSchemesQuotientsCanonicalLaneLean.ReviewerBridge

/-!
# Theorem Statement Layer

This module internalizes the theorem-facing object for `group-actions-varieties-schemes-quotients-canonical-lane`
